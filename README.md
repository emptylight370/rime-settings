...
2. 通过 [Release 万象词库-刷拼音-辅助码工具，在线更新方案 GUI](https://github.com/amzxyz/RIME-LMDG/releases/tag/tool) 处理一遍词库拼音，得到 `_.dict.pinyin.yaml` 文件（工具 `wanxiang-tools.exe`，更新于 2026/08/21 22:11（GMT+8））
...
现在使用的长期支持版本语言模型更新时间为：2026/08/20 22:56（GMT+8）。
